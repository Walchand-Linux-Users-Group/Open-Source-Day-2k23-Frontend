...
const Mid = () => {
  return (
    <div className={styles.bg}>
      ...
      <img src="https://i.ibb.co/JtPvvQZ/Copy-of-UI-OSD-2-min.png" alt="Copy-of-UI-OSD-2-min" className={styles.mob}></img>
      <img src="https://i.ibb.co/NmJNn4S/Copy-of-UI-OSD-6.png" alt="Copy-of-UI-OSD-6" className={styles.pc}></img>
